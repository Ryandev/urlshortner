...
import type { AppThemeCustom, AppThemeOptions } from '../interface';
...
const theme: AppThemeCustom & AppThemeOptions & Record<string, unknown> = {
    colors: {
        gradients: {
...
export const NebulaFighterTheme = createTheme(theme);
